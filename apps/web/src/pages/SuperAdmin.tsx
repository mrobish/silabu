...
type Page = 'dashboard' | 'users' | 'settings' | 'password' | 'broadcast' | 'profile' | 'addAdmin' | 'payment-gateways' | 'price-settings' | 'whatsapp';
...
const menu = [
  ...
  { page: 'whatsapp' as Page, label: 'WhatsApp OTP', icon: 'M3 21l1.65-3.8a9 9 0 1 1 3.4 2.9L3 21' },
];
...
export default function SuperAdmin() {
  ...
  const pageTitle = page === 'password' ? 'Ubah Password' : page === 'dashboard' ? 'Dashboard' : page === 'users' ? 'Management User' : page === 'broadcast' ? 'Broadcast' : page === 'profile' ? 'Profil Saya' : page === 'addAdmin' ? 'Tambah Admin' : page === 'payment-gateways' ? 'Payment Gateways' : page === 'price-settings' ? 'Atur Harga' : page === 'whatsapp' ? 'WhatsApp OTP' : 'Settings';
  ...
  return <div className="min-h-screen bg-slate-50">
    ...
    <main className={ML + ' min-h-screen transition-all duration-300 ease-in-out'}>
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        {page === 'whatsapp' && <div className="animate-fade-in">
