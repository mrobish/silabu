        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="animate-fade-up stagger-2 text-base sm:text-lg text-slate-500 max-w-md mx-auto md:mx-0 mb-8 sm:mb-10 leading-relaxed">
              Input transaksi harian, sistem menyusun jurnal double-entry secara otomatis. Laporan Neraca, Laba Rugi, Arus Kas, dan Perubahan Modal tersedia dalam format PDF sesuai ketentuan Kepmendes 136/2022.
            </p>
            <Link
              to="/register"
              viewTransition
          ...
          <div className="animate-fade-up stagger-2 relative">
            ...
            <div className="absolute -bottom-3 -left-3 sm:-bottom-4 sm:-left-4 bg-white rounded-xl shadow-lg border border-slate-100 px-4 py-3 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-slate-900">Jurnal Double-Entry</p>
                <p className="text-xs text-slate-500">Sistem susun otomatis dari input transaksi</p>
              </div>
            </div>
          </div>
        </div>
          ...
          {[
            {
              ...
              bg: 'bg-emerald-50',
              title: 'Input Transaksi → Jurnal Otomatis',
              desc: 'Cukup input transaksi harian (pemasukan/pengeluaran). Sistem menyusun jurnal debit-kredit sesuai Chart of Accounts Kepmendes 136.'
            },
            {
              icon: (
              ...
              bg: 'bg-cyan-50',
              title: '4 Laporan Keuangan + PDF',
              desc: 'Neraca, Laba Rugi, Perubahan Modal, dan Arus Kas — format sesuai Kepmendes 136/2022, ekspor PDF dengan kop surat BUM Desa.'
            },
            {
              icon: (
              ...
              bg: 'bg-teal-50',
              title: 'CoA 304 Akun Standar',
              desc: 'Chart of Accounts langsung tersedia saat registrasi — 304 akun sesuai Kepmendes 136 Tahun 2022. Tidak perlu setup manual.'
            },
          ].map((f, i) => (
      ...
      <section className="border-t border-slate-100">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-16 sm:py-20 text-center">
          <h2 className="animate-fade-up text-2xl sm:text-3xl font-bold text-slate-900 mb-3">
            Butuh sistem akuntansi untuk BUM Desa Anda?
          </h2>
          <p className="animate-fade-up stagger-1 text-sm sm:text-base text-slate-500 mb-8 max-w-md mx-auto">
            Daftar gratis, langsung dapat Chart of Accounts 304 akun sesuai Kepmendes 136/2022. Tanpa kartu kredit.
          </p>
          <Link
            to="/register"
            viewTransition
